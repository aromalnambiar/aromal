...
export default function Document() {
	return (
		<Html lang="en">
            ...
            <Head>
                {/*
				Author: Aromal Nambiar
                 GitHub: Visit the GitHub repository at https://github.com/aromalnambiar/portfolio/ for more details.
                 license: MIT License
                  */}
                <meta charSet="utf-8"/>
                <meta httpEquiv="X-UA-Compatible" content="IE=edge"/>
                {/* eslint-disable-next-line @next/next/no-title-in-document-head */}
                <title>Aromal Nambiar</title>
                <meta name="description"
                      content="Aromal Nambiar - A dedicated Full Stack Developer proficient in App/Web, Cloud, DevOps, AL/ML, and Design. Join my journey."/>

                {/*These are need for PWA*/}
                <meta name="apple-mobile-web-app-capable" content="yes"/>
                <meta name="apple-mobile-web-app-status-bar-style" content="default"/>
                <meta name="apple-mobile-web-app-title" content="Aromal Nambiar"/>
                ...
                <link rel="canonical" href="https://aromalnambiar.com"/>
                <meta name="license" content="MIT License"/>
                <meta httpEquiv="content-language" content="en-us"/>

                <link rel="preconnect" href="https://aromalnambiar.com"/>

                <link rel="dns-prefetch" href="https://aromalnambiar.com"/>

                <meta name="author" content="Aromal Nambiar"/>

                <link rel="alternate" hrefLang="en" href="https://aromalnambiar.com"/>
                ...
                <meta property="og:title" content="Aromal Nambiar" key="title"/>
                <meta property="og:description"
                      content="Aromal Nambiar - A dedicated Full Stack Developer proficient in App/Web, Cloud, DevOps, AI/ML, and Design. Join my journey."/>
                ...
                <meta property="og:image:alt" content="Aromal Nambiar"/>
                <meta property="og:image:width" content="300"/>
                <meta property="og:image:height" content="300"/>
                <meta property="og:url" content="https://aromalnambiar.com"/>
                <meta property="og:type" content="website"/>
                <meta property="og:profile" content="https://github.com/aromalnambiar"/>
                <meta property="og:site_name" content="Aromal Nambiar"/>
                <meta property="og:locale" content="en_US"/>


                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:site" content="https://twitter.com/aromalnambiar_"/>
                <meta name="twitter:title" content="Aromal Nambiar"/>
                <meta name="twitter:description"
                      content="Aromal Nambiar - A dedicated Full Stack Developer proficient in App/Web, Cloud, DevOps, AI/ML, and Design. Join my journey."/>
                <meta name="twitter:image" content="https://avatars.githubusercontent.com/u/75434191?v=4"/>
                <meta name="twitter:creator" content="https://twitter.com/aromalnambiar_"/>
                <meta name="twitter:domain" content="https://aromalnambiar.com"/>
    ...
    Aromal Nambiar, Full Stack Engineer, Full Stack Developer, DevOps Engineer, Software Engineer,
    ...
    Full Stack Web Developer, Aromal Nambiar Portfolio, Coding Projects, Tech Portfolio,
    Web Development, DevOps Professional, Aromal Nambiar Projects, Software Engineer Portfolio,
    ...
    Full Stack Engineer Portfolio, Aromal Nambiar Web Developer,
    Software Development Student, Coding Enthusiast, DevOps Portfolio, Programming Portfolio,
    Aromal Nambiar DevOps, IT Portfolio, Web Developer Portfolio, Aromal Nambiar Developer,
    Full Stack Engineer Aromal Nambiar, Aromal Nambiar Coding, Aromal Nambiar IT,
    Aromal Nambiar Full Stack Developer, Aromal Nambiar Software Engineer, Aromal Nambiar DevOps Engineer,
    Aromal Nambiar Programming, Aromal Nambiar Software Development, Aromal Nambiar Coding Projects,
    Aromal Nambiar Tech Portfolio, Aromal Nambiar IT Portfolio, Aromal Nambiar Software Engineer Portfolio,
    Aromal Nambiar Web Developer Portfolio, Aromal Nambiar DevOps Portfolio, Aromal Nambiar Full Stack Engineer,
    Aromal Nambiar Full Stack Developer Portfolio, Aromal Nambiar Coding Portfolio, Aromal Nambiar Programming Portfolio,
    Aromal Nambiar Software Development Portfolio, Aromal Nambiar Technology Projects,
    Aromal Nambiar Computer Science, Aromal Nambiar Cloud Computing, Aromal Nambiar IT Professional,
    Aromal Nambiar Technology Enthusiast, Aromal Nambiar Computer Programmer, Aromal Nambiar Code Portfolio,
    Aromal Nambiar Technology Student, Aromal Nambiar Software Architect,fiaz,fiaz portfolio,fiaz devops,fiaz devops engineer,
...
"/>
        ...
        />
          ...
          "@type": "Person",
          "name": "Aromal Nambiar",
          "url": "https://aromalnambiar.com",
          "sameAs": [
            "https://github.com/aromalnambiar",
            "https://www.linkedin.com/in/aromalnambiar-",
            "https://medium.com/@aromalnambiar",
            "https://twitter.com/aromalnambiar_",
            "https://dev.to/aromalnambiar"
          ]
        }`
                    }}
                />
                    ...
                    __html: `
          {
            ...
            "mainEntity": [
              ...
              {
                "@type": "Question",
                "name": "Who is Aromal Nambiar?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Aromal Nambiar is a Full Stack Developer specializing in Cloud, DevOps, ML/AI, and Design. He is passionate about programming, innovation, and shaping the future. With expertise in various technologies and a strong background in software development, Aromal Nambiar strives to create innovative solutions and contribute to the advancement of technology. His skill set includes proficiency in cloud computing, DevOps practices, machine learning/artificial intelligence, and design principles. Aromal Nambiar is dedicated to staying up-to-date with the latest industry trends and leveraging his knowledge to drive impactful and transformative projects."
                }
              },
              {
                "@type": "Question",
                "name": "Where is Aromal Nambiar from?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Aromal Nambiar is from Madurai, Tamil Nadu, India."
                }
              },
              {
                "@type": "Question",
                "name": "What does Aromal Nambiar do?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Aromal Nambiar leverages Cloud, DevOps, ML/AI, Design, and web/mobile apps to benefit people with optimized operations and user-friendly experiences."
                }
              }
            ]
          }
        `,
                    ...
                    __html: `
          {
            ...
            "itemListElement": [{
              ...
              "position": 1,
              "name": "Home",
              "item": "https://aromalnambiar.com/"
            },{
              "@type": "ListItem",
              "position": 2,
              "name": "Docs",
              "item": "https://aromalnambiar.com/docs"
            },{
              "@type": "ListItem",
              "position": 3,
              "name": "Articles",
              ...
              "position": 4,
              "name": "Projects",
              "item": "https://aromalnambiar.com/projects"
            },{
              "@type": "ListItem",
              "position": 5,
              "name": "Sign In",
              "item": "https://aromalnambiar.com/signin"
            }]
          }
        `
                }}/>
                    ...
                    __html: `
          {
            ...
            "url": "https://github.com/aromalnambiar/neurolink",
