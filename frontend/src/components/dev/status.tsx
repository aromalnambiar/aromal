                    ...
                    {hideContent ? null : (
                        <>
                            ...
                            <p style={{ fontSize: '14px', marginBottom: '30px' }}>
                                ...
                                <a href="https://github.com/aromalnambiar/portfolio/issues/new">@aromalnambiar</a>
                            </p>
                            {!isVerified ? (
                                <>
                    ...
                    {WelMsg && (
                        <div>
                            <h2 style={{ fontSize: '32px', marginBottom: '20px'}}>
                                <span dangerouslySetInnerHTML={{ __html: WelMsg.replace('Github', '<a href="https://github.com/aromalnambiar" target="_blank" rel="noopener noreferrer" style="color: #3498db;">Github</a>') }} />
                            </h2>
                            {timerRemaining !== null && (
                ...
                {autoupdatecheck && (
                    ...
                    >
                        <p>
                            ...
                            {versionDetails ? (
                                <a
                                    href={`https://github.com/aromalnambiar/portfolio/releases/tag/v${versionDetails.currentVersion}`}
                                    target="_blank"
